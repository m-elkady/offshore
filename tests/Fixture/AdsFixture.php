...
class AdsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'location' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'display_order' => 1,
            'active' => 1,
            'created' => '2016-07-11 17:01:39',
            'modified' => '2016-07-11 17:01:39'
        ],
    ];
}
