 ...
 *
 */
class QuotationItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'quotation_items_ibfk_1' => ['type' => 'foreign', 'columns' => ['quotation_id'], 'references' => ['quotations', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'quantity' => 1,
            'unit_price' => 1.5,
            'created' => '2018-04-18 21:53:36',
            'modified' => '2018-04-18 21:53:36'
        ],
    ];
}
